...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Select and map ideal functions.")

    parser.add_argument(
        "--data-dir", default="datasets", help="Folder containing the CSV files."
    )

    parser.add_argument(
        "--output-dir", default="output", help="Folder for generated output."
    )
